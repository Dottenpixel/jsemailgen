...
Delicious.Mp3 = {
	...
	go: function() {
		...
		for (var i = 0, o; o = all[i]; i++) {
			if(o.href.match(/\.mp3$/i)) {
				...
				img.src = basePath+'inc/lib/playtag/ico_play_w.png'; img.title = 'listen'
				...
				o.onclick = Delicious.Mp3.makeToggle(img, o.href)
				o.href = "#"
	}}},
	toggle: function(img, url) {
		if (Delicious.Mp3.playimg == img) Delicious.Mp3.destroy()
			...
			img.src = basePath+'inc/lib/playtag/ico_stop_w.png'; Delicious.Mp3.playimg = img;
			...
			'<param name="movie" value="'+basePath+'inc/lib/playtag/player.swf" /><param name="quality" value="high" />' +
			'<embed style="vertical-align:bottom;margin-right:0.2em" src="'+basePath+'inc/lib/playtag/player.swf" flashVars="theLink='+url+'&amp;fontColor='+c+'"'+
	...
	destroy: function() {
		Delicious.Mp3.playimg.src = basePath+'inc/lib/playtag/ico_play_w.png'; Delicious.Mp3.playimg = null
