...
echo <<<DISPLAY_UPLOAD_FORM
        	<h1>Add News Article <a href="viewNewsArticles.php">View News Articles</a></h1>

            <form method="post" action="{$_SERVER['PHP_SELF']}" enctype="multipart/form-data">
        
            <label for="inpFile">Select News Article PDF file: <input id="inpFile" type="file" size="30" name="submittedFile" tabindex="1" /></label>
            
        
            <label for="inpTitle">News Article Title: <input id="inpTitle" name="pubTitle" size="40" type="text" /></label>
        
            <label for="inpPubDate">News Article Date: <input id="inpPubDate" class="datePicker" name="pubDate" size="10" maxlength="10" type="text" /></label>
